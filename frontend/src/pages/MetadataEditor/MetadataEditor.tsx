                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {item?.llmDescription != null && (
                        <EditorTextItem
                          name="LLM Description"
                          value={item?.llmDescription}
                          helpInfo="Description that was automatically generated by vision large language model. Currently updating is unsupported."
                          showFixedIcon={!!item.isTranscriptFixed}
                          onValueChange={(val) => {
                            const it = getItem(index);
                            setDirtyStatusAndRefresh(index, true);
                            if (it) {
                              it.llmDescription = val;
                              listRef.current?.forceUpdate();
                            }
                          }}
                          updateDisabled
